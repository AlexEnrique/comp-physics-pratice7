\documentclass[aps,secnumarabic,balancelastpage,amsmath,amssymb,nofootinbib,floatfix]{revtex4-1}
...
%\begin{document}
%\title{Escrevendo o relatório para o laboratório fisica 1 de graduação em \LaTeX}
%\author{A. Fulano}
%\email{email@ufabc.edu.br}
%\author{B. Sicrano}
%\author{C. Beltrano}
%\homepage{http://web.mit.edu/8.13/} %If you don't have one, just comment out this line.
%\date{\today}
%\affiliation{Centro de Ciências Naturais e Humanas, Universidade Federal do ABC - UFABC}
%
%\maketitle
